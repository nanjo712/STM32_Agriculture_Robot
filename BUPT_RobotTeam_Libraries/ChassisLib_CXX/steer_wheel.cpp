...
//        dji_PosCfg(STEER_WHEEL_DJIV2_BOARDID, i + 1, STEER_WHEEL_MAX_SPEED);
        DJIBoard_MotorOn(&hcan1,STEER_WHEEL_DJIV2_BOARDID, i + 1);
        DJIBoard_PosCfg(&hcan1,STEER_WHEEL_DJIV2_BOARDID, i + 1, STEER_WHEEL_MAX_SPEED);
    }
}
...
//    dji_PosCtrlAll(1, target_pos_int);
    DJIBoard_PosCtrlAll(&hcan1,1, target_pos_int);
}
